...
interface CommunityWaitlistModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
}

export default function CommunityWaitlistModal({ isOpen, onClose, onSuccess }: CommunityWaitlistModalProps) {
  const { t } = useLanguage();
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // Persist state
      localStorage.setItem('hasAppliedCommunity', 'true');
                ...
                {!isSuccess ? (
                  ...
                  >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="space-y-2">
                        <label className="block text-sm font-bold text-white">
                          {t('community.waitlist.github.label')}
                        </label>
                        <input
                          type="text"
                          value={githubLink}
                  ...
                  >
                    ...
                    <h3 className="text-2xl font-headline font-bold text-white mb-2">
                      {t('community.waitlist.success.title')}
                    </h3>
                    ...
                    <p className="text-sm text-on-surface-variant leading-relaxed">
                      {t('community.waitlist.success.desc')}
                    </p>
                  </motion.div>
                )}
              </AnimatePresence>
